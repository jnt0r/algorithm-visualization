...
describe('GridBox', () => {
    ...
    //
    //
    //     it('should only set isVisited if element is start', () => {
    //         box.markStart();
    //         resetCalls(mockRectangle);
    //         box.markVisited();
    //
    ...
    //     });
    //
    //     it('should only set isVisited if element is goal', () => {
    //         box.markGoal();
    //         resetCalls(mockRectangle);
    //         box.markVisited();
    //
    ...
    //
    // describe('markStart', () => {
    //     it('should set color of element', () => {
    //         box.markStart();
    //
    //         verify(mockRectangle.setColor('#F00'));
    //         verify(mockRectangle.setBorderColor('#F00'));
    //     });
    // });
    //
    // describe('markGoal', () => {
    ...
    //         box.markGoal();
    //
    //         verify(mockRectangle.setColor('#0F0'));
    //         verify(mockRectangle.setBorderColor('#0F0'));
    //     });
    // });
    //
    // describe('markPartOfPath', () => {
    //     it('should set color of element', () => {
    //         box.markPartOfPath();
    //
    //         verify(mockRectangle.setColor('#04d9ff'));
    //         verify(mockRectangle.setBorderColor('#04d9ff'));
    //     });
    // });
    //
    // describe('reset', () => {
    //     it('should set costs to maximum', () => {
    //         box.setCost(0);
    //         box.reset();
    //
    //         expect(box.getCost()).toBe(Number.MAX_VALUE);
